...
if (TYPO3_MODE == 'BE') {
	t3lib_extMgm::addModulePath('web_txsubsitewizardM1', t3lib_extMgm::extPath($_EXTKEY) . 'mod1/');

	t3lib_extMgm::addModule('web', 'txsubsitewizardM1', '', t3lib_extMgm::extPath($_EXTKEY) . 'mod1/');
}
